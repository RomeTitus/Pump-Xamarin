...
{
    class OfflineDatabase : IDictionary<string, OfflineEntry>
    {
        ...
        public OfflineDatabase(Type itemType, string filenameModifier)
        {
            ...
            db = new LiteRepository(new LiteDatabase(fileStream, mapper));
        ...
        {
            cache.Clear();
            db.Delete<OfflineEntry>(new BsonValue(Query.All()));
        }
        ...
        private string GetFileName(string fileName)
        {
            ...
            foreach (char c in invalidChars.Concat(Path.GetInvalidFileNameChars()).Distinct())
            {
